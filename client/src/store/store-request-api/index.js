...
export const searchPlaylistsByUsers = (searchTerm) => {
    return api.post(`/search-users/`, {searchTerm})
}
export const searchPlaylists = (searchTerm) => {
    return api.post(`/search-playlists/`, {searchTerm})
}
export const deletePlaylistById = (id) => api.delete(`/playlist/${id}`)
export const getPlaylistById = (id) => api.get(`/playlist/${id}`)
export const getPlaylistPairs = () => api.get(`/playlistpairs/`)
export const getPublishedPlaylists = () => api.get(`/published-playlists/`)
